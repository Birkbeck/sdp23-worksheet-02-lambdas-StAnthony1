...
public class Outline {
  ...
  private static int orderByE(String s1, String s2) {
    ...
    public static void main (String...args){ // varargs alternative to String[]
      ...
      //Arrays.sort(fruitBowl, (f1, f2) -> {
        //if (f1.contains("e") & !f2.contains("e")) return -1;
        //return 0;
     // });
      System.out.println(Arrays.asList(fruitBowl));

    Arrays.sort(fruitBowl, Outline::orderByE);
      System.out.println(Arrays.asList(fruitBowl));
    }
}
